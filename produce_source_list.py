...
# number of sources, the 1st-3rd column contain the x,y,z indexing (in Fortran Formar i.e. starting from 1).
# The 4th and 5th column contains the halo mass in solar mass/h of the HMACH halos and LMACH halos respectively
# and the 6th column contains the LMACH masses multipled by a factor of (1/(9x10^8) -1/9) as in eqn. 3 of
# Dixon et al. (2018) which is used for the mass dependant supression source model. 
